		...
		<div class="jumbotron">
			...
			<form class="form-horizontal" action="" method="POST">
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="first">First Lesson</label>  
				  <div class="col-md-8">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="second">Second Lesson</label>  
				  <div class="col-md-8">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="third">Third Lesson</label>  
				  <div class="col-md-8">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="fourth">Fourth Lesson</label>  
				  <div class="col-md-8">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="fifth">Fifth Lesson</label>  
				  <div class="col-md-8">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="sixth">Sixth Lesson</label>  
				  <div class="col-md-8">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="seventh">Seventh Lesson</label>  
				  <div class="col-md-8">
				...
				<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="eight">Eight Lesson</label>  
				  <div class="col-md-8">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
					<button id="submit" name="submit" class="btn btn-primary">Add Duration</button>
				  </div>
				</div>
