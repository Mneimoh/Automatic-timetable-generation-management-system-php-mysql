<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand"><!--Sharda University --> Time Table Generator</a>
    </div>
    <div>
      <ul class="nav navbar-nav">
        ...
        <li><a href="add.faculty.php"><span class="glyphicon glyphicon-user"></span> Add School</a></li> 
        <li><a href="add.course.php"><span class="glyphicon glyphicon-education"></span> Add Class</a></li> 
		<li><a href="edit.timing.php"><span class="glyphicon glyphicon-time"></span> Duration</a></li> 
