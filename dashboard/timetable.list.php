				...
				while($result = $query->fetch()){
				  echo "<tr>"
						 ...
						 ."<td><a href='delete.table.php?delete=true&id=".$result['timetable_id']."'><span class='glyphicon glyphicon-trash'></span></a> | 
							<a href='../view.table.php?view=true&id=".$result['timetable_id']."&year=".$result['year']."&semester=".$result['semester']."&coursecode=".$result['course']."&coursefullname=".$result['course_full_name']."&faculty_name=".$result['faculty']."'><span class='glyphicon glyphicon-search'></span></a>
