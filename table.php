<?php
	...
	if($_SESSION['name']){
		...
		$query = $link->query("SELECT * FROM timetable WHERE semester='$semester' AND course ='$course_code' AND course_full_name='$course_full_name' AND faculty='$faculty' AND user_id='$user_id'");
		$query->setFetchMode(PDO::FETCH_ASSOC);
		
		while($result = $query->fetch()){
            $_SESSION['course_full_name'] = $result['course_full_name'];
...
<div class="Table">
	...
	<p> </p>
		...
		<p>Term - <?php if($_SESSION['name']) echo $_SESSION['semester']; ?>  (Press Crt + p to Download)</P>
    </div>
    <div class="Heading">
        <div class="Cell">
            <p>Time/Day</p>
